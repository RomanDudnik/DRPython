...
# actions = {'y': f'Создать новый справочник {path}\n',
#            'q': 'Выйти и указать имя файла в переменной "path"'}
# action = None
...
#     print(f'Справочник по умолчанию {path} еще не создан.\n'
#     'Укажите имя файла в переменной "path", если у вас есть справочник с другим именем')
#     while action !='q':
#         print('Создать новый справочник?\n', *[f'{i} - {actions[i]}' for i in actions])
#         action = input()
#         while action not in actions:
#             print('Введены неверные данные')
#             if action =='q':
#                 path = input('Введите вашего название файла, находящегося в дирректории:')              
#             elif action =='y':
#                 file = open(path, 'w')
